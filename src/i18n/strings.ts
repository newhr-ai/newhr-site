...
export const strings = {
  tr: {
    ...
    hero: {
      ...
      titleLine1: "AI'ı izleyen mi,",
      titleLine2Accent: "uygulayan mı?",
      lead1: "Her hafta gerçek uygulanabilir HR örnek uygulamaları.",
      lead2: "Eğitimden işe alıma bütçe yönetimine.",
      lead3: "Her hafta, 15 yıllık HR pratiğinden test edilmiş yöntemler.",
      ctaPrimary: "Bültene Kaydol →",
      ctaSecondary: "AI Fluency Testini Yap →",
      proof1: "15+ YIL İK TECRÜBESİ",
      proof2: "2 BANKANIN İK'SINI SIFIRDAN KURDU",
      proof3: "ICF ONAYLI YÖNETİCİ KOÇU",
    },
    steps: {
  ...
  en: {
    ...
    hero: {
      eyebrow: "AI FOR HR. BY HR.",
      titleLine1: "Watching AI,",
      titleLine2Accent: "or applying it?",
      lead1: "Real, applicable HR examples every week.",
      lead2: "From training and hiring to budget planning.",
      lead3: "Tested methods from 15 years of senior HR practice.",
      ctaPrimary: "Join the Newsletter →",
      ctaSecondary: "Take the AI Fluency Test →",
      proof1: "15+ YEARS OF HR EXPERIENCE",
      proof2: "BUILT HR FUNCTIONS AT 2 BANKS FROM SCRATCH",
      proof3: "ICF-CERTIFIED EXECUTIVE COACH",
    },
    steps: {
